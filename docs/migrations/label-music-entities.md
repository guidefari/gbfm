...
4. Migration `0042_sudden_natasha_romanoff.sql` copies and validates all label content, creator relationships, and external links before replacing the legacy tables.
5. Confirm `/labels`, a representative `/labels/:slug`, and `/admin/music` after deployment.
