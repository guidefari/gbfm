  ...
  <section className="pb-8 body-font">
    <div className="container flex flex-col mx-auto lg:px-5 lg:py-24">
      <div className="w-full">
        <div className="flex flex-col-reverse justify-between lg:flex-row md:mt-10 lg:items-center lg:">
          <div className="text-center lg:py-8 lg:pr-8 md:-translate-y-20 md:-translate-x-32 lg:translate-x-0 lg:translate-y-0 ">
            <Image
              src="/images/yo.png"
              placeholder="blur"
          ...
          <div className="pt-4 mb-4 border-gray-200 sm:mb-0 lg:border-l sm:py-8 sm:pl-8 ">
            <h1 className="mb-0 text-5xl font-bold leading-none text-right md:text-8xl lg:text-6xl xl:text-9xl">
              goosebumps.
              <br />
