...
export type SelectRelease = InferSelectModel<typeof releasesTable> & { tags: Array<string> | null }

export type InsertRelease = InferInsertModel<typeof releasesTable> & { tags?: Array<string> }
