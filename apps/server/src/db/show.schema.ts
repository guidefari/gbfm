...
export type SelectShow = InferSelectModel<typeof showsTable> & { tags: Array<string> | null }

export type InsertShow = InferInsertModel<typeof showsTable> & { tags?: Array<string> }
