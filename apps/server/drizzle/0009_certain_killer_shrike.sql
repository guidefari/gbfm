...
CREATE TABLE "user_email_preferences" (
	...
	CONSTRAINT "user_email_preferences_unsubscribeToken_unique" UNIQUE("unsubscribeToken")
);
--> statement-breakpoint
...
ALTER TABLE "user_email_preferences" ADD CONSTRAINT "user_email_preferences_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
