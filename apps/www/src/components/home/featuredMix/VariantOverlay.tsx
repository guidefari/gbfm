    ...
    <div className='flex flex-col w-full gap-3'>
      <div className='relative w-full overflow-hidden border-2 aspect-square border-foreground'>
        ...
        <div className='absolute inset-0 flex flex-col justify-between p-3'>
          <span className='self-start px-2 py-1 text-[10px] font-bold uppercase tracking-[0.25em] leading-none border bg-highlight text-gb-bg border-foreground'>
            Featured
          </span>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <button
              ...
              className='inline-flex items-center justify-center w-full gap-2 px-5 py-3 text-sm font-bold tracking-widest uppercase transition-all border-2 bg-highlight text-gb-bg border-foreground hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 disabled:cursor-not-allowed'>
              {isPending ? (
