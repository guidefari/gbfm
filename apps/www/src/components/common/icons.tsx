...
export const Icons = {
  ...
  gitHub: (props: IconProps) => (
    <svg viewBox='0 0 438.549 438.549' aria-label='GitHub' {...props}>
      <path
        fill='currentColor'
  ...
  radix: (props: IconProps) => (
    <svg viewBox='0 0 25 25' fill='none' aria-label='Radix UI' {...props}>
      <path
  ...
  npm: (props: IconProps) => (
    <svg viewBox='0 0 24 24' aria-label='npm' {...props}>
      <path
  ...
  yarn: (props: IconProps) => (
    <svg viewBox='0 0 24 24' aria-label='Yarn' {...props}>
      <path
  ...
  pnpm: (props: IconProps) => (
    <svg viewBox='0 0 24 24' aria-label='pnpm' {...props}>
      <path
  ...
  react: (props: IconProps) => (
    <svg viewBox='0 0 24 24' aria-label='React' {...props}>
      <path
  ...
  tailwind: (props: IconProps) => (
    <svg viewBox='0 0 24 24' aria-label='Tailwind CSS' {...props}>
      <path
