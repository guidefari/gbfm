<script lang="ts">
  ...
  let { shows, selected, episodes = [], failure = null }: { shows: ReadonlyArray<PublicRecord>; selected: PublicRecord | null; episodes?: ReadonlyArray<PublicRecord>; failure?: string | null } = $props()
