      ...
      <div className="max-w-screen-xl px-4 mx-auto lg:px-6">
        ...
        <div className="grid pt-8 text-left md:gap-8 md:grid-cols-2">
            <Collablock title="Curate music for your friends">
              It should be easy to put together groups of music that you want to share with your friends.
            </Collablock>
            ...
            <Collablock title="Long-form content, & Micro posts">
              Similar to what Substack supports.
              I like the idea of having separate spaces for long-form content, and short-form tweet sized thoughts.
            </Collablock>
