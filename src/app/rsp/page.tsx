...
import type { ResponseType as RandomPlaylistApiResponse } from "@/pages/api/v2/random-playlist";
...
export default function RSP() {
	...
	} = useSWR<RandomPlaylistApiResponse>(
		shouldFetch ? "/api/v2/random-playlist" : null,
		fetcher,
	);
					...
					<div className="space-y-10 text-center">
						{playlistLoading && (
							<p className="mb-4 text-left text-gray-400">
								Fetching your playlists. Wait time may be a little longer if you
								have many playlists.
							</p>
						)}
						<div className="flex flex-col justify-center space-y-3">
							...
							>
								{playlistLoading ? (
									<SpinningCircleLoaderThingy />
								) : (
									"Take me to random playlist"
								)}
							</button>
							<button
