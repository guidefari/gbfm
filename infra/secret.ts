export const secret = {
  SpotifyClientId: new sst.Secret('SpotifyClientId', process.env.SPOTIFY_CLIENT_ID),
  SpotifyClientSecret: new sst.Secret('SpotifyClientSecret', process.env.SPOTIFY_CLIENT_SECRET),
  ...
  SENTRY_BACKEND_DSN: new sst.Secret('SENTRY_BACKEND_DSN', process.env.SENTRY_BACKEND_DSN),
  ...
  BETTER_AUTH_SECRET: new sst.Secret('BETTER_AUTH_SECRET', process.env.BETTER_AUTH_SECRET),
  BETTER_AUTH_URL: new sst.Secret('BETTER_AUTH_URL', process.env.BETTER_AUTH_URL)
}
